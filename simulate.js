...
const FILTERS = {
  ...
  "スコア50未満": (e) => e.score != null && e.score < 50,
  "スコア45未満": (e) => e.score != null && e.score < 45,
  "上位拮抗(gap2未満)": (e) => e.gap != null && e.gap < 2,
  "決勝のみ": (e) => /決勝/.test((e.grade || "").replace(/準決勝?/, "")),
  "荒れ+拮抗": (e) => e.verdict === "×荒れ含み" && e.gap != null && e.gap < 3,
  ...
  "評価1位が先頭": (e) => { const l = (e.lines || []).find((x) => x.includes((e.ranks || [])[0])); return !!(l && l.length >= 2 && l[0] === e.ranks[0]); },
  "評価1位が番手以降": (e) => { const l = (e.lines || []).find((x) => x.includes((e.ranks || [])[0])); return !!(l && l.length >= 2 && l[0] !== e.ranks[0]); },
  "本命ライン3人+スコア58+": (e) => { const l = (e.lines || []).find((x) => x.includes((e.ranks || [])[0])); return !!(l && l.length >= 3) && e.score >= 58; },
  "評価1位が先頭+スコア58+": (e) => { const l = (e.lines || []).find((x) => x.includes((e.ranks || [])[0])); return !!(l && l.length >= 2 && l[0] === e.ranks[0]) && e.score >= 58; },
  "◎のみ": (e) => e.verdict === "◎スジ堅い",
...
const FILTER_COND = {
  ...
  "スコア50未満": { scoreMax: 50 },
  "スコア45未満": { scoreMax: 45 },
  "上位拮抗(gap2未満)": { gapMax: 2 },
  "決勝のみ": { gradeRe: "(?<!準)決勝" },
  "荒れ+拮抗": { verdict: "×荒れ含み", gapMax: 3 },
  ...
  "評価1位が先頭": { topIsHead: true },
  "評価1位が番手以降": { topIsHead: false },
  "本命ライン3人+スコア58+": { lineSizeMin: 3, scoreMin: 58 },
  "評価1位が先頭+スコア58+": { topIsHead: true, scoreMin: 58 },
};

...
const ALL = (hist.entries || []).filter((e) => Array.isArray(e.ranks) && e.ranks.length >= 4 && (e.p2pay || e.p3pay));
...

{
  ...
  {
  const nPat = Object.keys(PATTERNS).length + Object.keys(N2_PATTERNS).length;
